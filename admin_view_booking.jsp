...
<br><br>
 ...
 <form action="" method="post" name="form1" id="form1" >
                        ...
                        <table width="90%" border="0" align="center">
                             <tr>
                                 <td height="53" colspan="9"><div align="center" class="style1 style3">  <h1 style="color:#e6b800;">Movie Details : </h1></div></td></h1>
                            </tr>
                             <tr>
                           
                           
                              <td width="91"><h4 align="center" class="style8 style2">Movie Id</h4></td>
                             <td width="91"><h4 align="center" class="style8 style2">Theater Name</h4></td>
                              <td width="55"><h4 align="center" class="style8 style2">Movie Name</h4></td>
                              <td width="55"><h4 align="center" class="style8 style2">User Name</h4></td>
                              <td width="55"><h4 align="center" class="style8 style2">Count</h4></td>
                             
                              <td width="55"><h4 align="center" class="style8 style2">Ticket Amount</h4></td>
                             
                              <td width="91"><h4 align="center" class="style8 style2">Total Amount</h4></td>
                             ...
                             <%     
                              ...
                              String pname = (String)session.getAttribute("sname");
                                ...
                                ResultSet rs0 = stmt3.executeQuery("select * from payment ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                           ...
                           <tr>
                                ...
                                <td><div align="center"><span class="style5">
                                         ...
                                         <td><div align="center"><span class="style5">
                                            <% out.print(rs0.getString("person"));%>
                                        </span></div></td>
                               <td><div align="center"><span class="style5">
                                            <% out.print(rs0.getString("tamount"));%>
                                        </span></div></td>
                                        <td><div align="center"><span class="style5">
                                            <% out.print(rs0.getString("total"));%>
                                        </span></div></td>
