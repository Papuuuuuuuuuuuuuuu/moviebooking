        ...
        if (btn.equals("Submit")) {
            ...
            String cac = request.getParameter("cac");
             String tamount = request.getParameter("tamount");
                    ...
                    String qry = "select max(id) as maxid from movie";
                    ...
                    String ins = "insert into movie values('" + id2 + "','" + tname + "','" + moviename + "','" + moviegenre + "','" + cac + "','" + tamount + "','0')";
...
<script language="javascript">
    ...
    window.location.href = "admin_add_movie.jsp";
</script>
<%
} else {
%>
...
<br><br>
    ...
    <form id="form" name="form" method="post" action="">
                <table width="100%" ailgn="center">
                    <tr>
                        <td height="45" colspan="4"><div align="center" ><h1>Add Movies : </h1></div></td>
                    </tr>
                    ...
                    <tr>
                       ...
                       <td width="25%"><input name="tname" type="text" class="style2"></td>
                    ...
                    <tr>
                        ...
                        <td width="25%"><input name="name" type="text" class="style2"></td>
                        <td width="25%">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td width="25%" height="61">&nbsp;</td>
                        <td width="25%"><div align="center" class="style2"><h2>Movie Genre:</h2> </div></td>
                        <td width="25%"><input name="moviegenre" type="text" class="style2"></td>
                        <td width="25%">&nbsp;</td>
                    </tr>
                    <tr>
                        <td width="25%" height="61">&nbsp;</td>
                        <td width="25%"><div align="center" class="style2"><h2>cast and crew: </h2></div></td>
                        <td width="25%"><input name="cac" type="text" class="style2"></td>
                        <td width="25%">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="25%"><div align="center" class="style2"><h2>Ticket Amount: </h2></div></td>
                         <td width="25%"><input name="tamount" type="text" class="style2"></td>
                        <td width="25%">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td height="54">&nbsp;</td>
                        <td><div align="center" >
                                <input id="popUpYes"  name="Submit" type="submit"  value="Submit">
                            </div></td>
