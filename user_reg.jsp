    ...
    try {
        ...
        if (btn.equals("Submit")) {
           ...
           if(email.matches(Email)){
                    String qry = "select max(id) as maxid from user_details";
            ...
            String ins = "insert into user_details values('"+id2+ "','" +name + "','" +contact + "','" + email + "','" + genter + "','" + address + "','"+ password  +"','0')";
...
<br><br>
 ...
 <form id="form" name="form" method="post" action="">
  ...
  <tr>
    <td height="45" colspan="4"><div align="center" ><h1>User Register : </h1></div></td>
   </tr>
  ...
  <tr>
    ...
    <td width="14%"><input name="contact" type="text" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
  <tr>
    <td width="38%" height="61">&nbsp;</td>
    <td width="12%"><div align="center" class="style2"><h2>Email : </h2></div></td>
    <td width="14%"><input name="email" type="text" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
  <tr>
    <td width="38%" height="61">&nbsp;</td>
 ...
 <td> <select name="genter" id="genter" style="width:150px ">
  ...
  <tr>
    ...
    <td><input name="password" type="password" class="style2"></td>
    <td>&nbsp;</td>
  </tr>
