 ...
 <form action="" method="post" name="form1" id="form1" >
                        ...
                        <table width="90%" border="0" align="center">
                             ...
                             <td width="91"><h4 align="center" class="style8 style2">Theater Name</h4></td>
                              ...
                              <td width="55"><h4 align="center" class="style8 style2">Movie Genre</h4></td>
                              <td width="55"><h4 align="center" class="style8 style2">Cast</h4></td>
                              <td width="55"><h4 align="center" class="style8 style2">Ticket Amount</h4></td>
                             
                              <td width="91"><h4 align="center" class="style8 style2">Delete</h4></td>
                             ...
                             <%     
                              ...
                              String pname = (String)session.getAttribute("sname");
                                ...
                                ResultSet rs0 = stmt3.executeQuery("select * from movie ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
                           ...
                           <tr>
                               ...
                               <td><div align="center"><span class="style5">
                                  ...
                                  <td><div align="center"><span class="style5">
                                             <a href="delete.jsp?id=<% out.print(rs0.getString("id"));%>"><h4>Delete</h4></a>
                                        </span></div></td>       
