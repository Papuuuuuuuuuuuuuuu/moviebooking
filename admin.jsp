 ...
 try
    {
        ...
        if(btn.equals("Submit"))
        {
          ...
          if((name.equals("parthi")) && (pass.equals("parthi")))
          {
              %>
...
<br><br>
       ...
       <h1 style="color:#e6b800;"align="center">Admin Login</h1>
      <form method="post" name="f1">
    <table align="center" height="150px" width="39%" border="">
  <tr>
    <td > <center> <label for="uname"><h5>USERNAME    :</h5></label></td>
    <td> <center><label><input type="text" id="uname" name="uname" placeholder="user name" ></label></center></td>
  </tr>
  <tr>
    <td> <center> <label for="password"><h5>PASSWORD     :</h5></label></td>
    <td> <center><label><input type="password" id="password" name="password" placeholder="Password"></label></center></td>
  </tr>
  <tr>
      <td ><div style="color:red;" ><center> <input class="siddiq" type="submit" id="btn"  name="btn" value="Submit"></div></td>
                  <td><div style="color:red;" ><center><input class="siddiq" type="Reset"  value="Clear"></center></div></td>
  </tr>
</table>
